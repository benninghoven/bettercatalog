...
SELECT DEPTCODE, COURSENUM, COURSELETTER, COURSENAME FROM COURSE WHERE DEPTCODE LIKE CONCAT(UPPER(@PARTIALDEPT), '%') AND COURSENUM LIKE CONCAT(@PARTIALNUM, '__%') AND COURSELETTER LIKE CONCAT(UPPER(@LETTER), '%');
